...
1. В программе должны использоваться вызовы функций CreateThread(), WaitForSingleObject()/WaitForMultipleObjects(), 
CreateSemaphore(), ReleaseSemaphore(), CloseHandle().
